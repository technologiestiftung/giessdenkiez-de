    ...
    watering: [
      {
        ...
        description:
          'Straßenbäume höheren Alters (>40 Jahre) haben in der Regel gelernt, sich über das Grundwasser selbst zu versorgen und benötigen keine zusätzliche Unterstützung. Einen niedrigen Wasserbedarf haben außerdem Jungbäume unter 3 Jahren, da diese im Normalfall durch die bezirklichen Grünflächenämter versorgt werden.',
      },
      {
        waterdrops: [1, 1],
        title: 'Mittlerer Wasserbedarf',
        description:
          'Mittelalte Bäume zwischen 15 und 40 Jahren werden in der Regel nicht mehr durch die Grünflächenämter  bewässert, haben aber schon ein gewisses Durchhaltevermögen. Sie freuen sich trotzdem über jede Gießkanne.',
      },
      {
        waterdrops: [1, 1, 1],
        title: 'Hoher Wasserbedarf',
        description:
          'Jungbäume zwischen 4 und 15 Jahren sind zu alt, um von den Straßen- und Grünflächenämtern standardmäßig bewässert zu werden, aber noch nicht alt genug, um sich in Hitzesommern selbst zu versorgen. Sie freuen sich über viel Wasser von bis zu 200l pro Gießung (alle 10 Tage).',
      },
    ],
    treetypes: [
      {
  ...
  collaborate: {
    ...
    tiles: [
      ...
      },
      {
        ...
        content:
        'Wenn du regelmäßig die gleichen Bäume gießen willst, kannst du sie abonnieren und so anzeigen, dass für sie gesorgt ist. So wird eine Koordinierung in der Nachbarschaft möglich.',
      },
      {
        icon: 'zoom',
        title: 'Den Baumbestand erkunden',
        content:
        'Unsere Karte ermöglicht es, mehr über einzelne Bäume oder den gesamten Baumbestand zu erfahren. Nutze die Filter- und Suchfunktion um mehr über die Bäume Berlins zu lernen.',
      },
      {
        icon: 'info',
