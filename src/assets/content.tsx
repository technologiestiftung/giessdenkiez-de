...
const content: Content = {
  ...
  whatsNew: {
    ...
    description: [
      'Mal wieder ein Frühjahrsputz. In den kommenden Tagen werden wir ein großes Update der Plattform vornehmen. Keine Angst - optisch verändert sich nichts. Unser Team hat sich jedoch die Finger wund getippt, um die Authentifizierung zu einem neuen Anbieter zu migrieren. Das macht unter anderem die technsiche Umsetzung für andere Städte wie Leipzig oder Magdeburg einfacher. Der große Vorteil für euch Nutzer:innen ist jedoch, dass ihr nach der Migration eure E-Mail, euer Passwort und euren Benutzer:innen-Namen direkt in Gieß den Kiez ändern könnt.',
      '<strong>Damit uns niemand unterwegs verloren geht, müssen wir für ein paar Tage das registrieren neuer Accounts deaktivieren.</strong> Gießen könnt ihr weitrerhin und all eure Gießleistungen bleiben natürlich erhalten. <br /><strong>Und zu guter Letzt - das neue Baumkataster für 2023 ist da! <br />\\o/ <br />Es sind circa 40.000 Bäume hinzugekommen. Viel Spaß beim Gießen!</strong>',
