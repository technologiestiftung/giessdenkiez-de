...
export const TreeAgeButton: React.FC<TreeAgeButtonProps> = ({
	...
	return (
		<div
			className={`${interval.enabled && "border-gdk-blue"} border-2 h-full flex flex-col justify-center text-center p-2 rounded-lg bg-[#F7F7F7] hover:cursor-pointer gap-0 p-2`}
			onClick={() => {
				onChange(interval);
			}}
		>
			<div className=" flex flex-col justify-center items-center">
				<img
					src="/images/tree-icon-green.svg"
					className={`${padding} w-[60%]`}
				></img>
			</div>
