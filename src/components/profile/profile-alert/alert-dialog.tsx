...
export const AlertDialog: React.FC<AlertDialogProps> = ({
	...
	return (
		<dialog
			id={"alert-dialog"}
			className="py-6 px-10 bg-gdk-lighter-gray shadow-gdk-hard rounded-2xl w-11/12 sm:w-[400px] flex flex-col backdrop:backdrop-blur"
		>
			...
			<div className="self-end my-2 lg:m-0">
				<PrimaryButton
					label={useI18nStore.getState().i18n().navbar.profile.settings.confirm}
					onClick={() => {
						(
