...
const TreeDetail: React.FC = () => {
	...
	return (
		<div className="pointer-events-auto h-full overflow-y-auto bg-white flex w-[100vw] flex-col gap-4 overflow-hidden overflow-scroll p-4 lg:w-[400px] lg:min-w-[400px]">
			<a
				href="/map"
